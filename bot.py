...
async def home(client, message):
  buttons = [[
    ...
    [
        InlineKeyboardButton('Our Channel', url='https://t.me/memerschatgroup'),
        InlineKeyboardButton('Source Code', url='https://t.me/memerschatgroup')
    ]]
...
async def help(client, message):
  buttons = [[
    ...
    [
        InlineKeyboardButton('Our Channel', url='http://t.me/memerschatgroup')
    ]]
  reply_markup = InlineKeyboardMarkup(buttons)
  await Tgraph.send_message(
        chat_id=message.chat.id,
